...
public class DatabaseTesting {
    ...
    public void testInsertCourse() {
        ...
        CourseRoom course2 = new CourseRoom(null, "0",
                "CSE 12 WINTER 2021", "mockSize");
        courseDao.insert(course2);


        CourseRoom course3 = new CourseRoom(null, "1",
                "CSE 11 FALL 2020", "mockSize");
        courseDao.insert(course3);


        CourseRoom course4 = new CourseRoom(null, "1",
                "CSE 12 WINTER 2021", "mockSize");
    ...
    public void testDeleteTwoCourses() {
        CourseRoom course1 = new CourseRoom(null,"0", "2020 FALL CSE 11", "mockSize");
        CourseRoom course2 = new CourseRoom(null, "0", "2021 WINTER CSE 12", "mockSize");
        CourseRoom course3 = new CourseRoom(null, "1", "2020 FALL CSE 11", "mockSize");
        CourseRoom course4 = new CourseRoom(null, "1", "2021 WINTER CSE 12", "mockSize");
